...
Tests cover deterministic RNG behavior, content counts and unique IDs, repeatable setup, legal-action enumeration, placement restrictions, occupied slots, rewards, costs, typed card effects, market replenishment, Forge gating, permanent face replacement, ordered events, passing, round completion, scoring, save round-trips, and deterministic legal CPU choices. Playwright verifies PixiJS board startup, the complete visual tutorial and replay flow, keyboard-accessible placement through the same engine actions, card play, Forge upgrades, and a complete six-round browser match. Later milestones must add advanced faction powers and broader balance simulations. Visual appearance never substitutes for rule assertions.
